    ...
    return `
      <article class="${cardClasses.join(" ")}">
        <a class="product-image-link" href="product.html?product=${product.slug}">
          <div class="product-image" data-image-src="${product.images[0]}" style="--product-image:url('${product.images[0]}');--product-image-alt:url('${product.images[1] || product.images[0]}')"><span class="image-fallback-label">${product.name}</span></div>
        </a>
        <div class="product-card-body">
          ...
          <span class="product-size">${product.sizes.join(" · ")}</span>
          ...
          <div class="product-actions">
            ...
            <button class="button button-sm add-cart-button" data-product-id="${product.id}" type="button">Add to Cart</button>
          </div>
        </div>
      </article>
    `;
