const Mouneh = (function () {
        ...
        <div class="header-inner">
          <a class="brand-logo" href="index.html">
            ...
            <div>
              ...
              <small>Lebanese pantry & gifts</small>
            </div>
          </a>
          <nav class="desktop-nav" aria-label="Primary navigation">
            ...
            <a href="shop.html?category=gift-boxes">Collections</a>
            <a href="shop.html?category=gift-boxes">Gifts</a>
          ...
          <div class="header-actions">
            ...
            <button class="icon-button" id="mobileMenuToggle" aria-label="Open menu">
              <span>Menu</span>
            </button>
    ...
    const footer = `
      <footer class="site-footer">
        <div class="footer-grid">
          <div>
            <strong>Mouneh w Khabrieh</strong>
            <p>Authentic Lebanese preserve house crafted for modern tables.</p>
          </div>
          <div>
            <span>Shop</span>
            ...
            <a href="shop.html?category=spices-herbs">Spices</a>
            <a href="shop.html?category=gift-boxes">Gift Boxes</a>
          </div>
          <div>
            <span>Our Story</span>
        ...
        <div class="footer-bottom">
          <p>© 2026 Mouneh w Khabrieh. All rights reserved.</p>
          <p>Design crafted for premium Lebanese specialty food experiences.</p>
        </div>
      </footer>
    `;
  ...
  function renderCategoryTiles(container, items) {
    ...
    container.innerHTML = items
      .map(
        (category, index) => `
        <a href="shop.html?category=${category.id}" class="category-tile category-tile-${index + 1}">
          <div>
      ...
      <article class="${cardClasses.join(" ")}">
        ...
        <div class="product-card-body">
          ...
          <div class="product-actions">
            <button class="text-button wishlist-button" data-product-id="${product.id}" type="button">${isWishlisted ? "Saved" : "Wishlist"}</button>
            <button class="button button-sm add-cart-button" data-product-id="${product.id}" type="button">Add</button>
          </div>
        </div>
      </article>
    `;
  ...
  function renderSectionProducts(container, items) {
    if (!container) return;
  ...
  function attachProductCardEvents(context) {
    ...
    wishlistButtons.forEach((button) => {
      button.addEventListener("click", () => {
        ...
        button.textContent = added ? "Saved" : "Wishlist";
      });
    });
  }
