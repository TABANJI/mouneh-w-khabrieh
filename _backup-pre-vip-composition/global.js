      ...
      <article class="${cardClasses.join(" ")}">
        <a class="product-image-link" href="product.html?product=${product.slug}">
          <div class="product-image" data-image-src="${product.images[0]}">
            ...
            <img class="product-packshot" src="${product.images[0]}" alt="${product.name}" loading="lazy" decoding="async" />
          </div>
        </a>
        <div class="product-card-body">
          ...
          <div class="product-actions">
            ...
            <button class="button button-sm add-cart-button" data-product-id="${product.id}" type="button" ${product.detailsPending ? "disabled" : ""}>${product.detailsPending ? "Coming Soon" : "Add to Cart"}</button>
          </div>
        </div>
      </article>
    `;
